...
- [x] 1. XSS Prevention - HTML Sanitization
  ...
  - [x] 1.4 Update warm.ts template to use sanitization
    - Apply same sanitization as simple.ts
    - _Requirements: 1.4_
  - [ ] 1.5 Write property test for HTML escaping
    - **Property 1: HTML Escaping Completeness**
    - **Validates: Requirements 1.1**
  - [ ] 1.6 Write property test for URL sanitization
...
- [ ] 4. IDOR Protection - Ownership Verification
  - [ ] 4.1 Add verifyProjectOwnership function to db/projects.ts
    - Check if device_id matches project owner or linked devices
    - Return boolean
    - _Requirements: 4.1, 4.2_
  - [ ] 4.2 Update PUT /api/projects/[id] to verify ownership
    - Call verifyProjectOwnership before update
    - Return 403 on failure
    - _Requirements: 4.1, 4.3_
  - [ ] 4.3 Update DELETE /api/projects/[id] to verify ownership
    - Call verifyProjectOwnership before delete
    - Return 403 on failure
    - _Requirements: 4.2, 4.3_
  - [ ] 4.4 Write property test for ownership verification
...
- [ ] 6. Security Headers
  - [ ] 6.1 Create middleware wrapper for adding security headers
    - Wrap response with addSecurityHeaders
    - _Requirements: 5.1, 5.2, 5.3, 5.4_
  - [ ] 6.2 Apply security headers to admin endpoints
...
- [ ] 7. Image Validation
  - [ ] 7.1 Create imageValidation.ts utility
  ...
  - [ ] 7.2 Update /api/analyze.ts to validate images
    - Call validateBase64Image before processing
    - Return 400 on invalid format
    - Check size limit (10MB)
    - _Requirements: 6.1, 6.2, 6.3_
  - [ ] 7.3 Write property test for image validation
    - **Property 9: Image Format Validation**
    - **Validates: Requirements 6.1**

- [ ] 8. Secure Error Handling
  - [ ] 8.1 Create production-safe error response utility
    - Strip stack traces and internal details
    - Return generic error messages
    - _Requirements: 7.2, 7.3_
  - [ ] 8.2 Update API endpoints to use safe error responses
    - Replace detailed error messages with generic ones in production
    - _Requirements: 7.2, 7.3_
  - [ ] 8.3 Write property test for error response safety
